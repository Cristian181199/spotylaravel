<x-contenido>
    ...
    <form action="{{ route('albumes.store', [], false) }}" method="POST"
        ...
        @csrf
        @method('POST')
        <h1 class="text-center text-2xl font-bold text-gray-500 mb-10">CREAR ALBUM</h1>
        <div class="space-y-4">
            <div>
            ...
            <button type="submit" class=" px-6 py-2 mx-auto block rounded-md text-lg font-semibold text-indigo-100 bg-indigo-600">Anadir album</button>
        </div>
    </form>
</x-contenido>
